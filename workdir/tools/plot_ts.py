    ...
    def plot(self):
        ...
        if not self.figsize_img:
            ...
            self.figsize_img = pp.auto_figure_size(
                ds_shape=ds_shape, disp_cbar=True, disp_slider=(not getattr(self, 'no_slider', False)), print_msg=False
            )
